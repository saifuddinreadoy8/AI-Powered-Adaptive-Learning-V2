...
export default function Register() {
  ...
  async function handleRegister(e) {
    ...
    // Sign up with role in metadata (trigger will create profile)
  ...
  const roles = [
    { value: 'student', icon: '📖', label: 'Student', desc: 'Practice quizzes & join classes' },
    { value: 'teacher', icon: '👩‍🏫', label: 'Teacher', desc: 'Create classes & conduct quizzes' },
  ]

  return (
    <div className="page-container flex items-center justify-center px-4 min-h-screen py-10">
      <div className="card w-full max-w-md fade-in">
        ...
        <div className="space-y-3 mb-6">
          <button
            ...
            className="w-full flex items-center justify-center gap-3 bg-white hover:bg-gray-100 text-gray-800 font-semibold py-3 px-4 rounded-xl transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {oauthLoading === 'google' ? (
          ...
          <button
            ...
            disabled={!!oauthLoading}
            className="w-full flex items-center justify-center gap-3 bg-[#24292F] hover:bg-[#32383F] text-white font-semibold py-3 px-4 rounded-xl transition-all duration-200 border border-slate-600 disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {oauthLoading === 'github' ? (
